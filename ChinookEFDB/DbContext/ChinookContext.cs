...
public partial class ChinookContext : Microsoft.EntityFrameworkCore.DbContext
{
...
//         => optionsBuilder.UseSqlServer("Server=(LocalDB)\\mssqllocaldb;attachdbfilename=C:\\Temp\\chinook\\Chinook.mdf;integrated security=True;MultipleActiveResultSets=True");
        ...
        modelBuilder.Entity<Playlist>(entity =>
        {
            ...
            entity.HasMany(e => e.Tracks)
                ...
                .UsingEntity<PlaylistTrack>(
                    ...
                    j =>
                    {
                        j.Property(pt => pt.TrackId).HasColumnName("TrackId");
                        j.Property(pt => pt.PlaylistId).HasColumnName("PlaylistId");
                        j.HasKey(t => new { t.PlaylistId, t.TrackId });
                    });
        });
